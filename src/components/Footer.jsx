...
export const Footer = () => {
  ...
  return (
    <footer
      ...
      <div className="container pt-9 w-[1000px]">
      <div className="flex justify-between w-full p-4 text-center textcolor">
        <br />
        <button onClick={handleNavigateToAllCampaigns} className='textcolor hover:text-[#FFFFFF] duration-500 ease-in-out'>All Crowdfunding Campaigns</button>
        <br />
        ...
        <br />
        <button onClick={handleNavigateToAbout} className='textcolor hover:text-[#FFFFFF] duration-500 ease-in-out'>About Us</button>
        <br />
        <button onClick={() => contactUsEmail()} className='textcolor hover:text-[#FFFFFF] duration-500 ease-in-out'>Contact Us</button>
        <br />
        <button onClick={() => handleNavigateToInfo()} className='textcolor hover:text-[#FFFFFF] duration-500 ease-in-out'>WhitePaper</button>
        <br />
        <button onClick={handleNaigateToVIP} className='textcolor hover:text-[#FFFFFF] duration-500 ease-in-out'>Become VIP Client</button>
      </div>
