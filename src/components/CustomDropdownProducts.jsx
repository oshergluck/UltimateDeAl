...
const CustomDropdownProducts = ({ categories, onSelect }) => {
  const [isOpen, setIsOpen] = useState(false);
  const [selectedItem, setSelectedItem] = useState('All');

  const toggleDropdown = () => setIsOpen(!isOpen);

  // This is the key change - we're making sure to call onSelect with the category
...
export default CustomDropdownProducts;