...
export default function DeployInvoices() {
  ...
  const handleDeploy = async () => {
    ...
    if (!formData.storeSymbol.trim()) {
      setError("Please enter Shop Symbol");
      return;
    }
    ...
    try {
      const params = {
        ...
        storeSymbol: formData.storeSymbol
      };
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-white mb-2">
                  ESH Shop Name <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  name="storeName"
              ...
              <div>
                <label className="block text-sm font-semibold text-white mb-2">
                ESH Shop Symbol <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  name="storeSymbol"
                  value={formData.storeSymbol}
                  onChange={handleInputChange}
                  placeholder="ESH Shop Symbol"
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none text-gray-900"
                  maxLength="10"
                />
                <p className="mt-1 text-xs text-gray-500">Symbol</p>
              </div>
