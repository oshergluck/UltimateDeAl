  ...
  return (
    <div>
        <div className='w-full mx-[auto] mt-[15px] mb-[100px] linear-gradient1 rounded-[15px] py-5'>
            ...
            <p className='text-[#FFFFFF] font-epilogue font-semibold text-[16px] mt-[10px] mb-[30px]'>Welcome to UltimateDeAl These Terms of Use ("Terms") govern your use of our website and services ("Services"), and by accessing and using our Services, you agree to these Terms. Please read them carefully.</p>
            ...
            <p className='text-[#FFFFFF] font-epilogue font-semibold text-[16px] mt-[10px] mb-[30px]'>All crowdfunding campaigns submitted to UltimateDeAl will undergo a thorough review process. We reserve the right to approve or reject any fundraising campaign or a store at our sole discretion. To verify your campaign or get your store listed we will contact you or contact us at emails if it passed 24 Hours.</p>
            ...
            <p className='text-[#FFFFFF] font-epilogue font-semibold text-[16px] mt-[10px] mb-[30px]'>All the investments works the special token $USDT, with this.. We are not responsible for lost of money because of a scam campaign. Always do your own reserch and speak with the person you want to invest in. This is why you have their Email or Mobile</p>
            ...
            <p className='text-[#FFFFFF] font-epilogue font-semibold text-[16px] mt-[10px] mb-[30px]'>Report is by email, If you have a problem with a campaign you can press report or send an email to support@UltimateDeAl.net</p>
            ...
            <p className='text-[#FFFFFF] font-epilogue text-[14px] mt-[70px] mb-[30px]'>Last updated: 24/11/2024</p>
