...
<>
  ...
  <section className="w-full rounded-t-[12px] px-4 sm:px-6 md:px-10 py-10 mt-5">
    <div className="max-w-6xl mx-auto text-center">
      ...
      <p className="text-white/85 text-base sm:text-lg mt-4 max-w-3xl mx-auto">
        Launch your token on a curve, then run a real business on-chain.
        This contract starts with
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
        ...
        <span className="px-3 py-1 rounded-full bg-white/10 text-white/90 text-xs sm:text-sm border border-white/15">
          On-Chain Store Registry
        </span>
        <span className="px-3 py-1 rounded-full bg-white/10 text-white/90 text-xs sm:text-sm border border-white/15">
          NFT Invoice Receipts
        </span>
        <span className="px-3 py-1 rounded-full bg-white/10 text-white/90 text-xs sm:text-sm border border-white/15">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
        ...
        <span className="inline-flex items-center rounded-xl bg-white/10 border border-white/15 px-4 py-2 text-sm text-white/90">
          🧾 Every sale mints a barcode-verified NFT invoice
        </span>
      </div>
    </div>
  </section>
  ...
  <section className="px-4 sm:px-6 md:px-10 py-8 ">
    <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="rounded-2xl border border-white/10 bg-black/30 p-5 backdrop-blur">
        <div className="text-white/60 text-sm">Invoice Receipts</div>
        <div className="text-white text-2xl font-bold mt-1">NFT-Based</div>
        <p className="text-white/70 text-sm mt-2">Proof of purchase, on-chain.</p>
      </div>

      <div className="rounded-2xl border border-white/10 bg-black/30 p-5 backdrop-blur">
        <div className="text-white/60 text-sm">Verification</div>
        <div className="text-white text-2xl font-bold mt-1">Barcode Scan</div>
        <p className="text-white/70 text-sm mt-2">Match barcode → verify ownership.</p>
      </div>
    </div>
  </section>
  ...
  <section className="px-4 sm:px-6 md:px-10 py-10 ">
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <h3 className="text-white text-lg font-semibold">5) Register Your Store (On-Chain)</h3>
          <p className="text-white/80 text-sm mt-2">
            Every shop gets a unique URL path and a store contract address in a public registry.
            Customers can find you, verify you, and review you — all transparently.
          </p>
        </div>

        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <h3 className="text-white text-lg font-semibold">6) Sell Products → Mint NFT Invoices</h3>
          <p className="text-white/80 text-sm mt-2">
            Each sale mints an <span className="text-emerald-300 font-semibold">NFT invoice receipt</span> tied to the{" "}
            <span className="text-amber-300 font-semibold">product barcode</span>. Anyone can verify ownership by barcode.
            Refunds can burn the invoice NFTs, keeping records clean.
          </p>
        </div>
      </div>
      ...
      <div className="mt-8 rounded-2xl border border-amber-300/25 bg-amber-400/10 p-6">
        <p className="text-amber-100 text-sm">
          ...
          Early curve entries get the edge. And when you start selling, your customers get barcode-verifiable NFT invoices.
        </p>
      </div>
    </div>
  </section>
  ...
  <section className="px-4 sm:px-6 md:px-10 py-10 ">
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="rounded-2xl border border-white/10 bg-black/30 p-6 lg:col-span-1">
          <h4 className="text-white font-semibold">On-Chain Store Registry</h4>
          <p className="text-white/75 text-sm mt-2">
            Stores are registered by URL path + store contract. Visibility, listing status, and discovery can be enforced on-chain.
          </p>
        </div>

        <div className="rounded-2xl border border-white/10 bg-black/30 p-6 lg:col-span-1">
          <h4 className="text-white font-semibold">NFT Invoice Receipts</h4>
          <p className="text-white/75 text-sm mt-2">
            Each purchase can mint invoice NFTs with metadata. Built for proof-of-purchase, warranty, and resale receipts.
          </p>
        </div>

        <div className="rounded-2xl border border-white/10 bg-black/30 p-6 lg:col-span-1">
          <h4 className="text-white font-semibold">Barcode Verification</h4>
          <p className="text-white/75 text-sm mt-2">
            Verify ownership by scanning a product barcode: match the barcode → check active (non-expired) ownership on-chain.
          </p>
        </div>
      </div>
    </div>
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
            ...
            <ul className="mt-2 space-y-2 text-white/80 text-sm break-all">
              ...
              <li>
                <span className="text-white/60">Router (BaseSwap):</span>{" "}
                0x327Df1E6de05895d2ab08513aaDD9313Fe505d86
              </li>
              <li>
                <span className="text-white/60">Factory (BaseSwap):</span>{" "}
                0xFDa619b6d20975be80A0A10332cD39b9a4b0FAa8BB
              </li>
              <li>
                <span className="text-white/60">UltraShop:</span>{" "}
                0x2bbedb2778996B849BaEebd0d81d55e31c1b29C8
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
            ...
            <ul className="mt-2 space-y-2 text-white/80 text-sm">
              <li>
                <span className="text-white/60">Virtual USDC:</span> 6,000
              </li>
              <li>
                <span className="text-white/60">LP Trigger:</span> 30% sold
              </li>
              <li>
                <span className="text-white/60">LP Premium:</span> +35%
              </li>
              <li>
                <span className="text-white/60">LP Lock:</span> LP tokens burned
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
            ...
            <ul className="mt-2 space-y-2 text-white/80 text-sm">
              <li>
                <span className="text-white/60">Required tokenA deposit:</span>{" "}
                1,000,000,000 (18d)
              </li>
              <li>
                <span className="text-white/60">Platform Fee:</span> 2% (200 bps)
              </li>
              <li>
                <span className="text-white/60">Creator Fee:</span> 1% (100 bps)
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-black/30 p-5 md:col-span-2 lg:col-span-3">
            ...
            <ul className="mt-2 space-y-1 text-white/80 text-sm list-disc list-inside">
              ...
              <li>
                Quotes:{" "}
                <code className="px-1 py-0.5 bg-white/10 rounded">getBuyQuote</code>,{" "}
                <code className="px-1 py-0.5 bg-white/10 rounded">getSellQuote</code>.
              </li>
              <li>Creator/Platform USDC fees accrue and are withdrawable via dedicated functions.</li>
              <li>Stores can mint NFT invoice receipts linked to product barcodes for instant on-chain verification.</li>
            </ul>
          </div>
        </div>
      )}
  ...
  <section className="w-full  px-4 sm:px-6 md:px-10 py-12 rounded-b-[12px]">
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mt-8 space-y-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
          <h3 className="text-amber-300 font-semibold">What are NFT invoices?</h3>
          <p className="text-white/80 text-sm mt-2">
            An NFT invoice is an on-chain receipt minted at checkout. It can include product metadata and is tied to a specific product barcode,
            so anyone can verify a real purchase without trusting screenshots or PDFs.
          </p>
        </div>

        <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
          <h3 className="text-amber-300 font-semibold">How do I verify an invoice by barcode?</h3>
          <p className="text-white/80 text-sm mt-2">
            Scan or enter the product barcode — the system checks if the wallet holds an active (non-expired) invoice NFT linked to that barcode.
          </p>
        </div>

        <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
          <h3 className="text-amber-300 font-semibold">What happens if there’s a refund?</h3>
          <p className="text-white/80 text-sm mt-2">
            Refund flows can burn the invoice NFTs tied to that receipt, so the on-chain record stays accurate and can’t be abused later.
          </p>
        </div>
