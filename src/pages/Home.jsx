    ...
    return (
        ...
        <div className="min-h-screen linear-gradient">
            ...
            <div className="mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <h1 className="sm:text-[80px] text-[35px] font-bold text-[#FFDD00] text-center my-[20px] sm:block hidden">UltimateDeAl Marketplace</h1>
                ...
                <div className=" mx-auto py-6 sm:px-6 lg:px-8">
                    ...
                    onClick={() => {navigate('/shop/UltimateDeAl/products/LISTESH')}}
                    >
