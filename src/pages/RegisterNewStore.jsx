          ...
          <div className="text-center space-y-4 sm:space-y-6">
            ...
            <div className="space-y-2 sm:space-y-3">
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
                  Your'e now registered at {form._urlPath}
              </p>
              <a className="text-xs sm:text-sm leading-relaxed" href={`https://ultrashop.tech/shop/${form._urlPath}`}>
                  Your'e now registered at ultrashop.tech/shop/{form._urlPath}
              </a>
              <a 
